...
@property (nonatomic, strong) LXPageView *pageView7;
@property (nonatomic, strong) LXPageView *pageView8;
...
- (void)viewDidLoad {
    ...
    UIView *bgViewRed = [[UIView alloc] initWithFrame:CGRectMake(0, bgView.bottom, bgView.width, bgView.height)];
    bgViewRed.backgroundColor = [UIColor colorWithHex:0xFF7F50];
    [self.view addSubview:bgViewRed];
    ...
    self.pageView2 = [[LXPageView alloc] initWithFrame:CGRectMake(80, 20.f, 80.f, 60.f) style:LXPageViewStyleHollowCircleMove pageCount:4];
    [bgView addSubview:self.pageView2];
    
    self.pageView3 = [[LXPageView alloc] initWithFrame:CGRectMake(160, 20.f, 80.f, 60.f) style:LXPageViewStyleCircleExchange pageCount:4];
    ...
    self.pageView5 = [[LXPageView alloc] initWithFrame:CGRectMake(0, 20.f, 80.f, 60.f) style:LXPageViewStyleHollowCircleToDisc pageCount:4];
    [bgViewRed addSubview:self.pageView5];

    self.pageView6 = [[LXPageView alloc] initWithFrame:CGRectMake(80, 20.f, 80.f, 60.f) style:LXPageViewStyleCircleDrag pageCount:4];
    [bgViewRed addSubview:self.pageView6];
    
    self.pageView7 = [[LXPageView alloc] initWithFrame:CGRectMake(160, 20.f, 80.f, 60.f) style:LXPageViewStyleCircleDragTail pageCount:4];
    [bgViewRed addSubview:self.pageView7];
