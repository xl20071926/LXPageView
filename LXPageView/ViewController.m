...
- (void)viewDidLoad {
    ...
    self.pageView1 = [[LXPageView alloc] initWithFrame:CGRectMake(0, 20.f, 80.f, 60.f) style:LXPageViewStyleLine pageCount:4];
    [bgView addSubview:self.pageView1];
    
    self.pageView2 = [[LXPageView alloc] initWithFrame:CGRectMake(80, 20.f, 80.f, 60.f) style:LXPageViewStyleCircle pageCount:4];
    [bgView addSubview:self.pageView2];
    
    self.pageView3 = [[LXPageView alloc] initWithFrame:CGRectMake(160, 20.f, 80.f, 60.f) style:LXPageViewStyleHollowCircle pageCount:4];
    [bgView addSubview:self.pageView3];
    
    self.pageView4 = [[LXPageView alloc] initWithFrame:CGRectMake(240, 20.f, 80.f, 60.f) style:LXPageViewStyleHollowCircle pageCount:4];
